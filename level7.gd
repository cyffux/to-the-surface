...
func _ready():
	...
	$wall/smoke15/AnimationPlayer.play("smoke")
...
func _on_read_body_entered(body):
	...
	child.text="YOU ARE SENT TO THE SURFACE TO BEAT THE CURSE"
...
func _on_jumper_body_entered(body):
	if body.name=="player":
		$wall/jumper11/AnimationPlayer.play("jump")
...
func _on_jumper2_body_entered(body):
	if body.name=="player":
		$wall/jumper12/AnimationPlayer.play("jump")
		get_node("../player").jumper=true
		velocitime=30
		$sound/AudioStreamPlayer.play()
...
func _on_jumper3_body_entered(body):
	if body.name=="player":
		$wall/jumper13/AnimationPlayer.play("jump")
		get_node("../player").jumper=true
		velocitime=30
		$sound/AudioStreamPlayer.play()
...
func _on_jumper4_body_entered(body):
	if body.name=="player":
		$wall/jumper14/AnimationPlayer.play("jump")
		get_node("../player").jumper=true
		velocitime=30
		$sound/AudioStreamPlayer.play()
